**TechVendetta VM670 TWRP Port**
This is the code for the TWRP recovery for the LG Optimus V and S
This includes a customized formating utility to aid in the creation of an
OS2SD card. There are still a few minor bugs to be ironed out but all core
functions work.
